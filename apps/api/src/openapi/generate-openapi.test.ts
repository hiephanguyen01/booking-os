...
test("generates the contract without binding a port or reaching infrastructure", async () => {
  ...
  try {
    ...
    assert.deepEqual(Object.keys(document.paths), [
      ...
      "/api/platform/security/users/{userId}/sessions/revoke",
      "/api/platform/tenants",
      "/api/platform/tenants/{tenantId}",
      "/api/platform/tenants/{tenantId}/owner-invitation/resend",
      "/api/ready",
      "/api/tenant/rbac/memberships/{membershipId}/roles",
      "/api/tenant/rbac/memberships/{membershipId}/roles/{roleId}",
      "/api/tenant/rbac/permissions",
      "/api/tenant/rbac/roles",
      "/api/tenant/rbac/roles/{roleId}",
      "/api/tenant/rbac/roles/{roleId}/permissions",
    ]);
    assert.deepEqual(
      ...
      [
        ...
        "getSessionCsrf",
        "getTenantRbacRole",
        "grantTenantMembershipRbacRole",
        "listSessions",
        "listTenantMembershipRbacRoles",
        "listTenantMemberships",
        "listTenantRbacPermissions",
        "listTenantRbacRoles",
        "loginSession",
        "logoutSession",
        ...
        "refreshSession",
        "replaceTenantRbacRolePermissions",
        ...
        "revokeTenantMembershipRbacRole",
