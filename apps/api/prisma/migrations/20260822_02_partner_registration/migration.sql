-- Sprint 3.2 Partner registration challenge persistence and verified establishment.
...
CREATE TABLE "partner_registration_challenges" (
  ...
  CONSTRAINT "partner_registration_challenges_id_tenant_id_key" UNIQUE ("id", "tenant_id"),
...
CREATE UNIQUE INDEX "partners_registration_challenge_id_tenant_id_key"
  ON "partners" ("registration_challenge_id", "tenant_id");
