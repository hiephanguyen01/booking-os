...
BEGIN
  INSERT INTO public."users" AS inserted_user (
  ...
  RETURNING inserted_user."id", inserted_user."authorization_version"
  ...
  WHERE existing_user."id" = existing_id
  RETURNING existing_user."authorization_version" INTO existing_version;
