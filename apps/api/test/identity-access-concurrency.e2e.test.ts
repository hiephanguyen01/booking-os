...
identityAccessTest(
  "S1B-AC04 owner activation and invitation acceptance are atomic under concurrency",
  () => {
...
identityAccessTest(
  "S1B-AC08 session lifetime, rotation, reuse detection, listing, and revocation remain race-safe",
  () => {
...
identityAccessTest(
  "S1B-AC10 grant boundaries and the final-owner invariant survive concurrent mutations",
  () => {
